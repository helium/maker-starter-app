...
const HeliumActionSheet = ({
  ...
  useEffect(() => {
    let nextSheetHeight = data.length * HeliumActionSheetItemHeight + 196 + (insets?.bottom || 0);
  ...
  }, [handlePresentModalPress, buttonProps, prefix, prefixTextProps, buttonTitle, textProps, icon]);
